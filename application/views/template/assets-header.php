...
<html lang="">
	<head>
		...
		<script type='text/javascript'>
	        ...
	        $(function(){
	          	$('.autocomplete_buku').autocomplete({
	                serviceUrl: site+'/buku/search',
	                onSelect: function (suggestion) {
	                    $('#v_judul').val(''+suggestion.judul); 
	                    $('#v_id_buku_tampil').val(''+suggestion.id_buku_tampil); 
	                    $('#v_id_buku').val(''+suggestion.id_buku); 
	                    $('#v_stok').val(''+suggestion.stok);
	                }
	            });
	        });
    	</script>
    	<script type='text/javascript'>
	        ...
	        $(function(){
	          $('.autocomplete_user').autocomplete({
	                serviceUrl: site+'/user/search',
	                onSelect: function (suggestion) {
	                    $('#v_nama').val(''+suggestion.nama); 
	                    $('#v_no_identitas').val(''+suggestion.no_identitas);
	                    $('#v_id_user').val(''+suggestion.id_user);
	                }
	            });
	        });
    	</script>
