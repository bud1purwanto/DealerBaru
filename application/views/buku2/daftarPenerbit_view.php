                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <span class="label label-primary" style="background-color: #1abc9c">Daftar Penerbit</span> <?php if ($status=="admin"): ?>
                                ...
                                <?php if (validation_errors() || $this->session->flashdata('gagal')) {
                                  ...
                                  <div style="margin-top: 100px; margin-left: 300px; width: 70%" class="modal-content">
                                    <div class="modal-header" style="background-color: #1abc9c">
                                      ...
                                      <h2>Penerbit <i class="glyphicon glyphicon-tasks"></i></h2>
                                    </div>
                                    <div class="modal-body">
                                      <div style="margin-top: 10px" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div style="margin-top: " class="form-group">
                                            ...
                                            <input class="form-control" id="nama_penerbit" type="text" name="nama_penerbit" value="<?php echo set_value('nama_penerbit') ?>" placeholder="Nama Penerbit">
                                        </div>
                                        <div style="margin-top: " class="form-group">
                                            <label>Alamat</label>
                                            <input class="form-control" id="alamat" type="text" name="alamat" value="<?php echo set_value('alamat') ?>" placeholder="Alamat Penerbit">
                                        </div>
                                        <div style="margin-top: " class="form-group">
                                            <label>Nomor HP</label>
                                            <input class="form-control" id="no_hp" type="number" name="no_hp" value="<?php echo set_value('no_hp') ?>" placeholder="Nomor HP">
                                        </div>
                                        <button style="height: 40px; width: 160px; margin-left: 310px;margin-top: 0px; background-color: #1abc9c" type="submit" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i> Input Penerbit</button>
                                        <?php echo form_close(); ?>
                        ...
                        <div class="table-responsive">
                          <?php if ($this->session->flashdata('sudah_input')) {
                            ...
                            <table class="table table-striped table-bordered table-hover" id="example">
                                ...
                                <tbody>
                                <?php $no=0; foreach ($penerbit_list as $key) { 
                                    $no++; ?>
                                    <tr>
                                        <td><?php echo $no ?></td>
                                        ...
                                        <?php if ($status=="admin"): ?>
                                            <td>
                                            <a href="<?php echo site_url('penerbit/edit/').$key->id_penerbit ?>" type="button" class="btn btn-default"><span class="glyphicon glyphicon-pencil " aria-hidden="true"></span></a>
                                            <a href="<?php echo site_url('penerbit/delete/').$key->id_penerbit ?>" type="button" class="btn btn-danger" onClick="JavaScript: return confirm('Anda yakin Hapus data ini ?')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                                        </td> 
                                        <?php endif ?>
                                    </tr>
                                <?php } ?>
